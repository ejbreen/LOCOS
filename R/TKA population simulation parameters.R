...
pop_sim_paramaters <- function(){
  ...
  Levels = list(Bearing = Bearing_levels, Poly_Type = Poly_Type_levels,
                Head_Size = Head_Size_levels, Approach = Approach_levels)
  ...
  return(list(C_pop_def = C_pop_def, T_pop_def = T_pop_def, Levels = Levels))
}
